...
def create_activity_search_agent(model: str = "litellm/gemini/gemini-2.0-flash-exp") -> Agent[TripContext]:
    ...
    kid_friendly_agent = create_kid_friendly_activity_agent(model=model)
