...
def create_weather_agent(mcp_servers: Sequence[MCPServer], model: str = "litellm/gemini/gemini-2.0-flash-exp") -> Agent[TripContext]:  
    ...
    Args:
        ...
        model: The model to use for the agent (defaults to Gemini via LiteLLM).
    """
